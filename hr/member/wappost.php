...
if($action=="postnew")
{
	...
	refreshto($FROMURL,"<a href='$FROMURL'>继续发布</a> <a href='../wapbencandy.php?fid=$fid&id=$id' target='_blank'>查看效果</a>",600);
...
elseif($action=="edit")
{
	...
	refreshto($FROMURL,"<a href='$FROMURL'>继续修改</a> <a href='../wapbencandy.php?fid=$fid&id=$id' target='_blank'>查看效果</a>",600);
}
else
{
	/*模块设置时,有些字段有默认值*/
