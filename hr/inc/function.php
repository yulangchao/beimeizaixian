...
function get_info_url($id,$fid,$city_id,$zone_id,$street_id,$array=array(),$filetype=''){
	if($id){
	...
	$city_id && $url .= "&city_id=$city_id";
	$zone_id && $url .= "&zone_id=$zone_id";
	$street_id && $url .= "&street_id=$street_id";	
	return $url;
}
