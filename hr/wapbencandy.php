...
$companydb[content]=str_replace("onload='if(this.width>600)makesmallpic(this,600,800);'","",$companydb[content]);
$companydb[content]=@preg_replace('/<img([^><]*)src="([^"]*)"([^><]*)>/is',"<img src='\\2'/>",$companydb[content]);	//把宽度代码过滤掉
