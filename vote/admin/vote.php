...
elseif($job=="list"&&ck_power('vote_list'))
{
	...
	$db->query("UPDATE `{$pre}vote_topic` SET name='$postdb[name]',about='$postdb[about]',type='$postdb[type]',limittime='$postdb[limittime]',limitip='$postdb[limitip]',begintime='$postdb[begintime]',endtime='$postdb[endtime]',forbidguestvote='$postdb[forbidguestvote]',ifcomment='$postdb[VoteUseComment]',votetype='$_POST[votetype]',tplcode='$votetpl' WHERE cid='$cid'");
