...
require_once(Mpath."data{$GLOBALS[webdb][web_dir]}/config.php");			//本系统全局变量值
require_once(Mpath."data{$GLOBALS[webdb][web_dir]}/all_fid.php");			//部分栏目的名称变量值
@include_once(ROOT_PATH."data{$GLOBALS[webdb][web_dir]}/ad_cache.php");	//全站广告变量缓存文件
require_once(ROOT_PATH."data{$GLOBALS[webdb][web_dir]}/label_hf.php");	//标签的头与底的变量值
