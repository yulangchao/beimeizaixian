...
if($action=="edit"||$action=="postnew")
{
	...
	$postdb['city_id'] || $postdb['city_id']=$city_id;
}
...
if($action=="postnew")
{
	...
	set_user_log(4);	//用户访问日志
 	...
 	refreshto("waplist.php?job=list","<a href='$Mdomain/wapbencandy.php?fid=$fid&id=$id' target='_blank'>查看效果</a> <a href='post.php?fid=$fid'>继续发表</a> <a href='waplist.php?job=list'>返回列表</a>",300);
}
