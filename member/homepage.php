...
//我的热门文章
$myhotnewsDB='';
$query = $db->query("SELECT * FROM {$pre}news_content WHERE uid='$uid' ORDER BY hits DESC LIMIT 10");
...
//我的图片主题
$myphotoDB='';
$query = $db->query("SELECT * FROM {$pre}news_content WHERE ispic=1 AND uid='$uid' ORDER BY id DESC LIMIT 4");
while($rs = $db->fetch_array($query)){
