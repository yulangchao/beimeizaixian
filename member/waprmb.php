...
if($job=='pwd'){
	...
	if( !$backDB[yeepay_id] && !$backDB[tenpay_id] && !$backDB[tenpay_id] && !$backDB[wapAlipay_id] && !$backDB[BACK]){
	...
	$backDB[wapAlipay_id] && $backDB[BACK][$backDB[wapAlipay_id]]="支付宝";
...
require(dirname(__FILE__)."/template/waprmb.htm");
