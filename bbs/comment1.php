...
if($atc=='comment'&&$id&&$content){
	...
	$db->query("INSERT INTO `{$_pre}comments` (`cuid`, `id`, `fid`, `uid`, `username`, `posttime`, `content`, `ip`, `icon`, `yz`, `cids`) VALUES ('$rss[uid]','$id','$fid','$lfjuid','$lfjid','$timestamp','$content','$onlineip','$icon','$yz','$cid')");
