...
$menu_partDB = array(
	'base'=>array('核心设置','微信功能设置','网站常用功能管理','数据库工具','菜单管理'),
...
$menudb=array(
	...
	'微信功能设置'=>array(		
		'微信接口设置' => array('power'=>'weixin_api','link'=>'index.php?lfj=center&job=weixin_api'),			
		'微信菜单设置' => array('power'=>'appmenu','link'=>'index.php?lfj=appmenu&job=list'),
		'用户关注时回复内容' => array('power'=>'weixin_FirstReply','link'=>'index.php?lfj=weixin_autoreply&job=FirstReply'),
		'用户提问自动回复' => array('power'=>'weixin_autoreply','link'=>'index.php?lfj=weixin_autoreply&job=list'),
		'微信客服设置' => array('power'=>'weixin_kefu','link'=>'index.php?lfj=weixin_kefu&job=list'),	
		'微信聊天记录' => array('power'=>'weixin_msg','link'=>'index.php?lfj=weixin_msg&job=list'),
	),
	'网站常用功能管理'=>array(
