...
{
	require("menu.php");
	$topMenu=$ForceEnter?'':"<li class='ck'><span onClick=\"showmenu('often','index.php?iframe=left&part=often')\" class='often'>快捷菜单</span></li> ";

	foreach($base_menuName  AS $key=>$value){
		$base_menuDB[$key]="<li><span onClick=\"showmenu('$key','index.php?iframe=left&part=$key')\" class='$key'>$value</span></li> ";
	}
