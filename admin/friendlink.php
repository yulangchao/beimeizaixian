...
elseif($action=="add")
{
	$db->query("INSERT INTO `{$pre}friendlink` (`name` , `url` ,`city_id` , `endtime` , `logo` , `descrip` , `list`,ifhide,yz,iswordlink,posttime,fid ) VALUES ('$postdb[name]','$postdb[url]','$postdb[city_id]','$postdb[endtime]','$postdb[logo]','$postdb[descrip]','0','$postdb[ifhide]','$postdb[yz]','$postdb[iswordlink]','$timestamp','$postdb[fid]')");
	write_friendlink();
