...
require(get_homepage_waptpl("head"));
require(get_homepage_waptpl("main"));
require(get_homepage_waptpl("foot"));
$content=ob_get_contents();


function get_homepage_waptpl($file){
	global $homepage_style,$style_tpl;
	if(is_file(Mpath."waphomepage_tpl/{$homepage_style}/{$file}.htm")){
		return Mpath."waphomepage_tpl/{$homepage_style}/{$file}.htm";
	}elseif(is_file(Mpath."waphomepage_tpl/{$style_tpl}/{$file}.htm")){
		return Mpath."waphomepage_tpl/{$style_tpl}/{$file}.htm";
	}elseif(is_file(Mpath."images/waphomepage_style/{$homepage_style}/{$file}.htm")){
		return Mpath."images/waphomepage_style/{$homepage_style}/{$file}.htm";
	}else{
		return Mpath."waphomepage_tpl/default/{$file}.htm";
	}
}
