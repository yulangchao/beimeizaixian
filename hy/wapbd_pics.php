...
function getOnlinecontact($type,$number,$jiange=" ")
{
	...
	foreach($number AS $id){
		if($id!=''){
			if($type=='qq'){
				$return.='<a target="blank" href="http://wpa.qq.com/msgrd?v=3&uin='.$id.'&site='.$webdb[webname].'&menu=yes"><img border="0" SRC=http://wpa.qq.com/pa?p=1:'.$id.':10 alt="点击这里与我联系" align="absmiddle"></a> '.$id.$jiange;
			}elseif($type=='msn'){
