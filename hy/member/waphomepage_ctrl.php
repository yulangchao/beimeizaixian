...
if(!$companydb[if_homepage]){
	showerr("您还没有申请企业商铺,<a href='$Murl/member/wappost_company.php?action=apply'>点击这里申请企业商铺</a>，拥有自己的商铺");
...
if($atn&&eregi("^([_a-z0-9]+)$",$atn)&&is_file(dirname(__FILE__)."/waphomepage_ctrl/$atn.php")){
	require_once(dirname(__FILE__)."/waphomepage_ctrl/$atn.php");
}

require(dirname(__FILE__)."/waphead.php");
require(dirname(__FILE__)."/template/waphomepage_ctrl.htm");
