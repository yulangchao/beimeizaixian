...
$query=$db->query("SELECT SQL_CALC_FOUND_ROWS * FROM {$pre}dianping_content $where ORDER BY posttime DESC LIMIT $min,$rows");
...
//-->
	...
	<div class="RightContainers">
		<div class="RightMainBox">
			<div class="head"><span class="tag">点评信息<em>&nbsp;</em></span></div>
			<div class="cont">
				<div class="ListShops">
$showlists
				</div>				
