...
$query=$db->query("SELECT SQL_CALC_FOUND_ROWS * FROM {$pre}2shou_content $where ORDER BY posttime DESC LIMIT $min,$rows");
	...
	$showlists.="<dl>
					...
					<dd>
						<ul>
							...
							<li>&yen;{$rs[sellprice]} <div class='gifnum'>购买价格:<span>&yen;$rs[buyprice]</span></div></li>
						</ul>
					</dd>
				</dl>";
}
...
//-->
	...
	<div class="RightContainers">
		<div class="RightMainBox">
			<div class="head"><span class="tag">二手信息<em>&nbsp;</em></span></div>
			<div class="cont">
				<div class="ListShops">
$showlists
				</div>				
