...
$query=$db->query("SELECT SQL_CALC_FOUND_ROWS * FROM {$pre}house_content $where ORDER BY $ordername DESC LIMIT $min,$rows");
...
<div class='MainContainer'>
	<div class='MinLefts'>
		<ul class='ShowType'>
			<li><a href="javascript:showHyNews('?showtype=moreshow&types=posttime&uid=$uid')">最新房产</a></li>
			<li><a href="javascript:showHyNews('?showtype=moreshow&types=hits&uid=$uid')">热门房产</a></li>
			<li><a href="javascript:showHyNews('?showtype=moreshow&types=levelstime&uid=$uid')">推荐房产</a></li>
		</ul>
	</div>
	<div class='MainRights'>
		<div class='head'><span class='tag'>房产信息</span></div>
