...
if(!$mystyledb[hidemenus]||($action=='setstyle')){
	...
	$set_footlink=($action=='setstyle')?"<a class='SetStyleBut' href='$WebStyleurl/setmenus.php?type=1&stylename=style1&uid=$uid&tag=footlink'>点击设置内容</a>":"";
...
if(!$mystyledb[hidecopyright]||($action=='setstyle')){
	...
	$set_copyright=($action=='setstyle')?"<a class='SetStyleBut' href='$WebStyleurl/setonlyone.php?type=1&stylename=style1&uid=$uid&tag=copyright'>点击设置内容</a>":"";
