...
$query=$db->query("SELECT SQL_CALC_FOUND_ROWS * FROM {$pre}shop_content $where ORDER BY $ordername DESC LIMIT $min,$rows");
...
<div class='MainContainer'>
	<div class='MinLefts'>
		<ul class='ShowType'>
			<li><a href="javascript:showHyNews('?showtype=moreshow&types=posttime&uid=$uid')">最新产品</a></li>
			<li><a href="javascript:showHyNews('?showtype=moreshow&types=hits&uid=$uid')">热门产品</a></li>
			<li><a href="javascript:showHyNews('?showtype=moreshow&types=levelstime&uid=$uid')">推荐产品</a></li>
		</ul>
	</div>
	<div class='MainRights'>
		<div class='head'><span class='tag'>商家产品</span></div>
