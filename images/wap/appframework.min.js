...
if (!window.af || "function" !== typeof af) {
    var af = function(g) {
        ...
        function F(a, c) {
            ...
            for (var b = ["Webkit", "Moz", "ms", "O"], d = 0; d < b.length; d++)"" === k.documentElement.style[b[d] + "Transform"] && (a.feat.cssPrefix = b[d])
        }
        function w(a) {
        ...
        function x(a, c, b, d, h) {
            ...
            function(b, c) {
                ...
                u = f || c,
                k = function(b) {
                    var c = u.apply(a, [b].concat(b.data)); ! 1 === c && b.preventDefault();
                    return c
                },
                f = e.extend(G(b), {
                    fn: c,
        ...
        m = function(a, c) {
            ...
            if (a) {
                ...
                if (af.isObject(a) && c == f) return this[this.length++] = a,
                this;
                if (c !== f) {
        ...
        e.map = function(a, c) {
            var b, d = [],
            h;
            if (e.isArray(a)) for (h = 0; h < a.length; h++) b = c.apply(a[h], [h, a[h]]),
            b !== f && d.push(b);
            else if (e.isObject(a)) for (h in a) a.hasOwnProperty(h) && "length" != h && (b = c(a[h], [h, a[h]]), b !== f && d.push(b));
            return af(d)
        };
        e.each = function(a, c) {
            var b;
            if (e.isArray(a)) for (b = 0; b < a.length && !1 !== c(b, a[b]); b++);
            else if (e.isObject(a)) for (b in a) if (a.hasOwnProperty(b) && "length" != b && !1 === c(b, a[b])) break;
            return a
        };
        e.extend = function(a) {
            a == f && (a = this);
        ...
        e.fn = m.prototype = {
            ...
            selector: function(a, c) {
                a = a.trim();
                if ("#" === a[0] && -1 == a.indexOf(".") && -1 == a.indexOf(",") && -1 === a.indexOf(" ") && -1 === a.indexOf(">")) c == k ? s(c.getElementById(a.replace("#", "")), this) : s(E(a, c), this);
            ...
            css: function(a, c, b) {
                ...
                for (b = 0; b < this.length; b++) if (e.isObject(a)) for (var d in a) this[b].style[d] = "number" === typeof a[d] && !L[d.toLowerCase()] ? a[d] + "px": a[d];
                else this[b].style[a] = "number" === typeof c && !L[a.toLowerCase()] ? c + "px": c;
                return this
            },
            ...
            toggle: function(a) {
                if (0 === this.length) return this;
                for (var c = !0 === a,
                b = 0; b < this.length; b++) if ("none" != this.css("display", null, this[b]) && (a == f || !1 === c)) this[b].setAttribute("afmOldStyle", this.css("display", null, this[b])),
                this[b].style.display = "none";
                else if ("none" == this.css("display", null, this[b]) && (a == f || !0 === c)) this[b].style.display = this[b].getAttribute("afmOldStyle") ? this[b].getAttribute("afmOldStyle") : "block",
            ...
            toggleClass: function(a, c) {
                ...
                e(this[b])[c ? "removeClass": "addClass"](a);
                return this
            },
            ...
            append: function(a, c) {
                ...
                C(a, this[b], c);
                    ...
                    if (h instanceof m) for (var u = 0,
                    l = h.length; u < l; u++) d = h[u],
                    d.nodeName != f && "script" == d.nodeName.toLowerCase() && (!d.type || "text/javascript" === d.type.toLowerCase()) ? g.eval(d.innerHTML) : C(e(d), this[b], c);
                    else c != f ? this[b].insertBefore(h, this[b].firstChild) : this[b].appendChild(h)
                }
                return this
            },
            ...
            closest: function(a, c) {
                ...
                for (; b && -1 == d.indexOf(b);) b = b !== c && b !== k && b.parentNode;
                return e(b)
            },
            filter: function(a) {
        ...
        e.jsonP = function(a) {
            if (r) return a.type = "get",
            a.dataType = null,
            e.get(a);
            var c = "jsonp_callback" + ++W,
            b = "",
            d, h = k.createElement("script");
            g[c] = function(d) {
                clearTimeout(b);
                e(h).remove();
                delete g[c];
        ...
        e.ajax = function(a) {
            ...
            try {
                ...
                b.headers));
                var h, f = b.context,
                k = /^([\w-]+:)\/\//.test(b.url) ? RegExp.$1: g.location.protocol;
                ...
                if (!1 === b.beforeSend.call(f, c, b)) return c.abort(),
                !1;
        ...
        e.fn.bind = function(a, c) {
            for (var b = 0,
            d = this.length; b < d; b++) x(this[b], a, c);
            return this
        };
        e.fn.unbind = function(a, c) {
            for (var b = 0,
            d = this.length; b < d; b++) y(this[b], a, c);
            return this
        };
        ...
        e.fn.delegate = function(a, c, b, d) {
            ...
            for (var h = 0,
            f = this.length; h < f; h++) V(this[h], c, d, a, b);
            return this
        };
        e.fn.undelegate = function(a, c, b) {
            for (var d = 0,
            e = this.length; d < e; d++) y(this[d], c, b, a);
            return this
        };
        ...
        function(a) {
            a.source == g && "afm-asap" == a.data && (a.stopPropagation(), 0 < B.length && B.shift().apply(M.shift(), N.shift()))
        },
        !0);
        var O = {};
    ...
    window.numOnly || (window.numOnly = function(g) {
        ...
        if (isNaN(parseFloat(g))) if (g.replace) g = g.replace(/[^0-9.-]/g, "");
        else return 0;
        return parseFloat(g)
    })
};