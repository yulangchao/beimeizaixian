...
if($job=="showmore"){	
	if(!$listdb){
		...
		foreach($listdb AS $key=>$rs){
		   ...
		   $str .= "<dl>
						<dt>
							<div class='img'><a href='wapbencandy.php?fid=$rs[fid]&id=$rs[id]'><img src='$rs[picurl]' onError=\"this.src='$webdb[www_url]/images/default/nopic.jpg'\"/></a></div>
						</dt>
						<dd>
							<div class='t'><a href='wapbencandy.php?fid=$rs[fid]&id=$rs[id]'>$rs[title]</a></div>
							<div class='more'><span><em>&yen;$rs[price]</em>/份</span> <a href=\"javascript:;JoinShopCar($rs[id])\"></a></div>
						</dd>
					</dl>";
		   echo $str;	
		}
