...
if($action=="postnew")
{
	...
	if($postdb[yz]==1){
		add_user($lfjdb[uid],$webdb[PostInfoMoney],'发布外卖商品奖励积分');
	}

	//置顶扣分
	if($iftop){
		add_user($lfjuid,-intval($webdb[Info_TopMoney]),'发布外卖商品置顶扣积分');
	}
